  ...
  return {
    ...
    setExchangeRate: newExchangeRate => {
      if (!newExchangeRate.conversion_rates){
        showAlert({ 
          message: 'O objeto precisa ter uma propriedade convesion_rates'
        })
...
const APIKey = '1ee5a67bc47db01f4019c851'
...
const handlCurrencyOneElInput = async e => {
...
currencyOneEl.addEventListener('input', handlCurrencyOneElInput)
